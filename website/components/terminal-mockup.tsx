...
{step >= 2 && (
  <>
    <div className="h-4" />
    <div className="text-indigo-400">__  __ __   __  ____     ___    _   _</div>
    <div className="text-indigo-400">\ \/ / \ \ / / |  _ \   / _ \  | \ | |</div>
    <div className="text-indigo-400"> \  /   \ V /  | |_) | | | | | |  \| |</div>
    <div className="text-indigo-400"> /  \    | |   |  _ <  | |_| | | |\  |</div>
    <div className="text-indigo-400">/_/\_\   |_|   |_| \_\  \___/  |_| \_|</div>
    <div className="h-6" />
  </>
)}
        {step >= 3 && (
